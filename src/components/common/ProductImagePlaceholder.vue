<template>
    <div class="bg-spanish-viridian/10 w-full h-full flex items-center justify-center rounded-sm">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink"
            aria-hidden="true"
            role="img"
            class="text-spanish-viridian w-1/3 aspect-square iconify iconify--uim"
            viewBox="0 0 24 24"
        >
            <path
                fill="currentColor"
