<template>
    <div class="store-home">
        ...
        <div class="pb-4 px-4 flex justify-between items-center">
            <div class="w-[76%] relative">
                <input
                    type="text"
                    placeholder="Search for by name"
                    v-model="productStore.searchInput"
                    class="bg-anti-flash-white text-dark-green placeholder:text-manatee rounded-sm w-full ps-8 pe-1.5 py-1.5 focus:outline-manatee"
                />
                <svg
                    width="16"
                    height="16"
            ...
            <div class="w-7.5 h-7.5">
                <button class="bg-anti-flash-white rounded-sm w-full h-full flex items-center justify-center cursor-pointer">
                    <svg
                        width="16"
                        height="16"
                        viewBox="0 0 16 16"
            ...
            <!-- cart  -->
            <div class="w-7.5 h-7.5">
                <button class="bg-anti-flash-white rounded-sm w-full h-full flex items-center justify-center cursor-pointer relative">
                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                        <path
                            opacity="0.4"
